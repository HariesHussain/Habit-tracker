        ...
        <div className="mt-auto pt-6 border-t border-gray-800 space-y-6">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="overflow-hidden">
              <p className="text-sm font-black text-white truncate uppercase italic">{profile?.name || 'User'}</p>
        ...
        {navItems.map((item) => (
          <Link
            ...
            className={`flex flex-col items-center gap-1.5 transition-all active:scale-90 ${
              location.pathname === item.path ? 'text-emerald-400 scale-110' : 'text-gray-500'
            }`}
          >
